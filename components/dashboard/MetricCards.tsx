  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
      ...
      <div className="lg:col-span-2 bg-white rounded-xl border border-gray-100 p-6 shadow-sm flex flex-col justify-between">
        <h3 className="text-gray-900 font-semibold text-sm mb-6">Sales Enquires (Orders)</h3>
        <div className="grid grid-cols-4 gap-4">
          <div>
            <div className="text-gray-500 text-xs mb-1">Total Enquires</div>
          ...
          <div>
            <div className="text-gray-500 text-xs mb-1">Pending Enquires</div>
            <div className="flex items-baseline">
          ...
          <div>
            <div className="text-gray-500 text-xs mb-1">Enquires Actioned</div>
            <div className="flex items-baseline">
          ...
          <div>
            <div className="text-gray-500 text-xs mb-1">SLA Breached</div>
            <div className="flex items-baseline">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="bg-gray-50/80 rounded-xl border border-gray-100 p-4 flex-1">
          <div className="text-gray-500 text-xs mb-1">Revenue from sales</div>
          <div className="flex items-baseline">
        ...
        <div className="bg-gray-50/80 rounded-xl border border-gray-100 p-4 flex-1">
          <div className="text-gray-500 text-xs mb-1">Revenue from commission</div>
          <div className="flex items-baseline">
